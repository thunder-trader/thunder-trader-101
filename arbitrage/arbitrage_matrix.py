...
def plot_one(main_plot, serials, slot0, slot1):
    ...
    serial_filer(diff_ask)
    serial_filer(diff_bid)
...
def plot_helper(file_name, serials, plot_list):
    ...
    for i in range(0, len(plot_list)):
        ...
        plot_one(left_plot, serials, plot_list[i][0], plot_list[i][1])
...
def price_diff_matrix(filename, instruments_list, start_date, end_date, data_center):
    ...
    plot_helper(filename, serials, plot_list)
...
if __name__ == '__main__':
    ...
    price_diff_matrix("%s/cu.png" % (REPORT_PATH), cu, '20250701', '20250731', DATA_CENTER)
